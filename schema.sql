...
--  TABLA: catalogo_bienes: NUMERO DE INVENTARIO, NUMERO DE SERIE,
--  DESCRIPCIÓN, MARCA, MODELO, UBICACIÓN, RESGUARDO
...
-- GRANT UPDATE ON sesiones_escaneo TO inv_app;
-- GRANT UPDATE ON usuarios TO inv_app;